 ...
 *
 * Extracted from ssl-converter.component.ts so the spec can import
 * pure functions without triggering Angular template/style webpack
 * loaders (templateUrl + styleUrl cause Module parse failed when
 * --include creates a minimal webpack entry).
 * ========================================================================= */

...
export class MsvModalComponent {
  ...
  // @ViewChild grabs the #modalContent element from the template so we can
  // dynamically insert components into it (used by the modal service).
